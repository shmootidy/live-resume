  ...
  render() {
    return (
      <div id="contact">
        ...
        <a href="#" className="contact-bar" id="phone">
        ...
        <a href="#" className="contact-bar" id="email">
        ...
        <a href="#" className="contact-bar" id="linked-in">
        ...
        <a href="#" className="contact-bar" id="github">
