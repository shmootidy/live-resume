  ...
  render() {
    return (
      <div id="contact">
        ...
        <a href="https://www.linkedin.com/in/shmoo-ritchie" target="_blank" className="contact-bar" id="linked-in">
        ...
        <a href="https://www.github.com/shmootidy" target="_blank" className="contact-bar" id="github">
