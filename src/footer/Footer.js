  ...
  return (
    <div id="footer-container">
      ...
      <div className="footer-icons">
        <a href="mailto:shmooritchie@gmail.com?subject=I saw your resume!"><FontAwesomeIcon icon={faAt} /></a>
        <a href="tel:+1-604-616-0247"><FontAwesomeIcon icon={faPhoneSquare} /></a>
        <a href="https://www.linkedin.com/in/shmoo-ritchie" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={['fab', 'linkedin']} /></a>
        <a href="https://www.github.com/shmootidy" target="_blank" rel="noopener noreferrer"><FontAwesomeIcon icon={['fab', 'github']} /></a>
      </div>
