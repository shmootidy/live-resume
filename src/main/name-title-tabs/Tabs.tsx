...
const Tabs = (props: any) => {
  ...
  const moreClasses = props.largeScreenTabs
    ? listClasses + " large-screen"
    : listClasses + " reg-tabs";
  const evenMoreClasses = props.nameTitleIsSticky
    ? moreClasses + " name-title-is-sticky"
    : moreClasses;
  return (
    <div>
